...
// Задача: нужно вывести кратчайший путь из точки А в точку Б с значениями расстояний
...
function getShortPathWithDistances(graph, start, end) {
...
console.log(getShortPathWithDistances(graph, 'a', 'e')); // [ {'a': 0}, {'i': 3}, {'e': 5} ]