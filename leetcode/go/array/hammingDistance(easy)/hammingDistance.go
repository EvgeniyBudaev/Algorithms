...
func hammingDistance(x int, y int) int {
	c := fmt.Sprintf("%032b", x) // Переводим в двоичное число с 32 знаками 00000000000000000000000000000001
	g := fmt.Sprintf("%032b", y) // Переводим в двоичное число с 32 знаками 00000000000000000000000000000100
	count := 0                   // Счетчик разрядов, где биты отличаются

	for i := 0; i < len(c); i++ { // Проходим по каждому разряду числа
