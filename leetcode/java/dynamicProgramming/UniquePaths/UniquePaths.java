package leetcode.java.dynamicProgramming.UniquePaths;
...
public class UniquePaths {
    ...
    // time: O(m * n), где m - количество строк, n - количество столбцов
    // space: O(n) - используем два массива размером n
    private static int uniquePaths(int m, int n) {
        int[] aboveRow = new int[n]; // Создаем временный массив для хранения промежуточных результатов
        ...
        for (int row = 1; row < m; row++) {
            int[] currentRow = new int[n]; // Создаем новый временный массив для текущей строки
