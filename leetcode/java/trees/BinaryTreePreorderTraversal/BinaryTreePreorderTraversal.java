package leetcode.java.trees.BinaryTreePreorderTraversal;
...
public class BinaryTreePreorderTraversal {
    ...
    private static void traverse(TreeNode node, List<Integer> result) {
        ...
        // Pre order - значит перед тем как рекурсивно идти в левое и правое поддерево 
        // мы добавляем значение узла в ответ.
