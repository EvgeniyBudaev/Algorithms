...
public class RemoveDuplicatesFromSortedArray {
    public static void main(String[] args) {
        ...
        // Выводим только первые k элементов, так как остальные не определены
        System.out.println(Arrays.toString(Arrays.copyOf(nums, k))); // [1, 2]
    }
    ...
    private static int removeDuplicates(int[] nums) {
        ...
        int k = 1; // Инициализируем количество уникальных элементов равным 1
