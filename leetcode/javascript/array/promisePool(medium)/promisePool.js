...
одновременно. promisePoolВам следует начать выполнять как можно больше функций и продолжить выполнение новых функций
после того, как старое обещание будет выполнено. promisePoolСначала его следует выполнить functions[i], затем выполнить
